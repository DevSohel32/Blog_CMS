...
$users = $stmt->fetchAll(PDO::FETCH_ASSOC);
          ...
          <div class="card bg-base-100 shadow-lg rounded-xl">
            <div class="card-body p-0">
              ...
              <div class="p-6">
                <div class="space-y-6">
                  <div
                    class="pb-6 border-b border-base-300">
                    <div class="avatar">
                      <div
                    ...
                    <div>
                      ...
                      <div class="flex gap-2 items-center">
                        <!-- Upload Button -->
                        <label class="btn btn-primary btn-sm flex items-center gap-1 cursor-pointer" for="fileInput">
                          <i class="ri-upload-line"></i> Upload New
                        </label>
  ...
  $("#fileInput").on("change", function () {
    ...
    $("#removeFile").on("click", function () {
      $("#avatarPreview").attr("src", "../assets/img_res/7ae1a804af8e025700424b5640eba190.jpg");
      $("#fileInput").val("");
    });
  </script>
